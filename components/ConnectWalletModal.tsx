...
function ConnectWalletModal({ isOpen, closeModal, openModal }: any) {
  return (
    <>
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center ">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl p-6 text-left align-middle shadow-xl transition-all bg-gray-700">
                  <Dialog.Title
                    as="h3"
                    className="text-lg font-medium leading-6 border-b-2 text-white border-b-gray-600 pb-3"
                  >
                    Connect Wallet
                  </Dialog.Title>
                  <div className="mt-2">
                  ...
                  <div className="mt-4">
                  <div>
                    <a href="#" className="inline-flex items-center text-xs font-normal text-gray-400 hover:underline dark:text-gray-400">
